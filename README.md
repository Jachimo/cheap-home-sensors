...
* **Bosch BME280 Sensor Module** - The BME280 is a very small SMT part, but
  ...
  mounting hole or two.  
    * Note that if you want relative humidity, be
...
* The sensor needs two I2C bus lines (clock and data), power, and ground.
...
The easiest way to deploy the code to an ESP device is probably with the [Thonny
IDE][thonny], although you can also use the [official Expressif `esptool`][esptool] CLI
toolsuite. 
